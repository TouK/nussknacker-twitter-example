...
public class TweetConverter2 {
    ...
    public static Schema TWEET_REFERENCED_TWEETS_ITEM_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema TWEET_ATTACHMENTS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema CONTEXT_ANNOTATION_DOMAIN_FIELDS_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema CONTEXT_ANNOTATION_DOMAIN_ENTITY_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema CONTEXT_ANNOTATION_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_WITHHELD_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Struct convert(@Nonnull TweetWithheld input) {
        return new Struct(TWEET_WITHHELD_SCHEMA)
                ...
                .put(TweetWithheld.SERIALIZED_NAME_COUNTRY_CODES, input.getCountryCodes())
    ...
    public static Schema POINT_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_GEO_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema URL_IMAGE_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema URL_ENTITY_SCHEMA = SchemaBuilder.struct()
        ...
        return new Struct(URL_ENTITY_SCHEMA)
                ...
                .put(UrlEntity.SERIALIZED_NAME_IMAGES,
                        Optional.ofNullable(input.getImages())
                                .map(list -> list.stream().map(TweetConverter2::convert).collect(Collectors.toList()))
                                .orElse(null));
    }
    ...
    public static Schema HASHTAG_ENTITY_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema MENTION_ENTITY_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema CASHTAG_ENTITY_SCHEMA = SchemaBuilder.struct()
    ...
    public static Schema FULL_TEXT_ENTITIES_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_PUBLIC_METRICS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_NON_PUBLIC_METRICS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_PROMOTED_METRICS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_ORGANIC_METRICS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_EDIT_CONTROLS_SCHEMA = SchemaBuilder.struct()
            .optional()
    ...
    public static Schema TWEET_SCHEMA = SchemaBuilder.struct()
